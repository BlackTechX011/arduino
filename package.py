...
for i, project in enumerate(projects):
    ...
    project_json = {
        "name": project,
        "maintainer": "BlackTechX011",
        "websiteURL": "https://github.com/BlackTechX011",
        "help": {
            "online": f"https://github.com/BlackTechX011",
        },
        "platforms": [],
        "tools": [],
    }
...
with open("package_BlackTechX_index.json", "w") as f:
